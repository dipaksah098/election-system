    ...
    <div className="max-w-screen-xl px-4 py-8 mx-auto sm:px-6 lg:px-8 bg-white dark:bg-gray-900 rounded-lg shadow-lg">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        <div className="flex flex-col p-6 bg-white dark:bg-gray-800 rounded-lg shadow-lg">
          ...
          <p className="text-lg font-normal text-gray-500 dark:text-gray-400 mb-6">Lorem ipsum dolor sit amet, consectetur adipiscing elit. In sed turpis nec mauris ultricies euismod.</p>
        ...
        <div className="flex flex-col p-6 bg-white dark:bg-gray-800 rounded-lg shadow-lg">
          <a href="#" className="flex items-center mb-4">
            <h5 className="text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Top 10 Web Development Frameworks</h5>
          </a>
          <p className="text-lg font-normal text-gray-500 dark:text-gray-400 mb-6">Lorem ipsum dolor sit amet, consectetur adipiscing elit. In sed turpis nec mauris ultricies euismod.</p>
        ...
        <div className="flex flex-col p-6 bg-white dark:bg-gray-800 rounded-lg shadow-lg">
          <a href="#" className="flex items-center mb-4">
            <h5 className="text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Best JavaScript Libraries for Web Development</h5>
          </a>
          <p className="text-lg font-normal text-gray-500 dark:text-gray-400 mb-6">Lorem ipsum dolor sit amet, consectetur adipiscing elit. In sed turpis nec mauris ultricies euismod.</p>
